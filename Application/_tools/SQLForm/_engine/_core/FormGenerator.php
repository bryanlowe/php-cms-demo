<?php
  ...
  class FormGenerator{
    ...
    public function __construct(){
      ...
      $this->formTemplate = file_get_contents($this->config->dir('sql-form').'/_templates/bll_form.txt');
    }
    ...
    private function generateFormClass(){
      ...
      foreach($inventory as $item){
        ...
        $fileName = $this->config->dir('sql-form').'/_forms/'.ucwords(str_replace(' ', '',$item->name)).'Form.php';

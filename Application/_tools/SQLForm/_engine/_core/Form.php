<?php 
  namespace Application\_tools\SQLForm\_engine\_core;
  ...
  class Form{
    ...
    protected function createForm(){
      $xslFile = new \DomDocument;
    	$xslFile->load($this->config->dir('sql-form').'/_templates/form.xsl');
    	$xmlFile = new \DomDocument;
    	$xmlFile->load($this->config->dir('sql-form').'/_settings/'.ucwords(str_replace(' ', '',$this->config->bllTables[$this->objectName])).'Settings.xml');

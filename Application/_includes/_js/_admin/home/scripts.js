$(document).ready(function(){
	var unreadFeedbackCount = Number(getCountFromTable('feedback','read_status = "0"',site_url+'admin/'));
	var unreadOrderCount = Number(getCountFromTable('orders','read_status = "0"',site_url+'admin/'));
